...
.PHONY: html help clean regenerate serve serve-global devserver devserver-global publish ssh_upload sftp_upload rsync_upload dropbox_upload ftp_upload s3_upload cf_upload github
